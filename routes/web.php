...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::group(['prefix' => 'account'], function () {
        ...
        Route::delete('/cost-center-force-delete/{id?}', ['as' => 'cost_center.force.delete', 'uses' => 'CostCenterController@forceDelete']);
    });
...
Route::get('/gen-pdf-report', 'ReportController@genPdf');

use Meneses\LaravelMpdf\Facades\LaravelMpdf as PDF;
use Gufy\PdfToHtml\Pdf as ConvertPdf;
...
//   $pdfd = new \TonchikTm\PdfToHtml\Pdf(public_path('g.pdf'));
//
//    foreach ($pdfd->getHtml()->getAllPages() as $page) {
//        echo $page . '<br/>';
//    }
