...
@section('javascript')
    ...
    <script>
        ...
        function print(){
            const keys = [
                {key: 'product', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 1},
                {key: 'sku', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 2},
                {key: 'location', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 3},
                {key: 'stock_left', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 4},
                {key: 'lot_number', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 5},
                {key: 'exp_date', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 5},
                {key: 'mfg_date', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false, index : 5}
                // {key: 'purchase', value: '', isTotalValue : false, isHtmlValue : false, isCurrency : false, isCount : false},

            ]
            stock_expiry_report_table.columns().header().map((d, index) => {
                try {
            ...
            const data = stock_expiry_report_table.data().toArray()
            const tableFooter = document.querySelector('#stock_expiry_report_table tfoot').outerHTML.toString();
            ...
            document.getElementById('print-title').defaultValue  = 'تقرير انتهاء صلاحية المخزون'
