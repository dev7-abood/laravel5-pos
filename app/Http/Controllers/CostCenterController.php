                ...
                return
                    "<div class='d-flex justify-content-center'>
                                <button type='button' class='btn btn-xs btn-primary btn-modal'
                                 ...
                                 data-href='$ac'><i class='glyphicon glyphicon-edit'></i>تعديل</button>
                    &nbsp;
                    <button id='delete_button' data-href='$destroy' class='btn btn-xs btn-danger delete_user_button' class='btn btn-xs btn-danger delete_user_button'><i class='glyphicon glyphicon-trash'></i> حذف</button></div>";
            })
            ->rawColumns(['actions'])
            ->make(true);
    }
                ...
                return
                    "<div class='d-flex justify-content-center'>
                                <button onclick='restore($id)' id='btn-restore' type='button' class='btn btn-xs btn-success'
                                 data-id='$id'><i class='glyphicon glyphicon-arrow-up'></i>تفعيل</button>
                    &nbsp;
                    <button id='delete_button' data-href='$destroy' class='btn btn-xs btn-danger delete_user_button' class='btn btn-xs btn-danger delete_user_button'><i class='glyphicon glyphicon-trash'></i> حذف نهائي</button></div>";
            })
            ->rawColumns(['actions'])
            ->make(true);
    }
